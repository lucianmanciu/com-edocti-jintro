...
public class PersonManagement {
	...
	public static void main (String[] args) {
		...
		// and not the objects themselves. references are sort of memory addresses
		...
		for (int i = 0; i < N; i++) {
			...
			int age = in.readInt();
			// this is only for consuming the "enter" we press after introducing the age
			in.readLine();
			persons[i] = new Person(firstName, lastName, age, sex, false);
		}
